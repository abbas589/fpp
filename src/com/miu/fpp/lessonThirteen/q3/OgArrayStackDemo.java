package com.miu.fpp.lessonThirteen.q3;
    ...
    class OgArrayStackDemo implements Stack2 {


        private Object a[];
        private int top; // stack top

        public OgArrayStackDemo(int n) // constructor
        {
    ...
    class ArrayStackDemo2 {
        public static void main(String[] args) {
            ...
            OgArrayStackDemo stk = new OgArrayStackDemo(210); // create stack of size 4
            Object item;
            ...
            OgArrayStackDemo stk1 = new OgArrayStackDemo(4);
            stk1.push("Java");
            stk1.push(20);
            stk1.push(30);
            item = stk.peek(); // get top item from the stack
